...
class UserExamsView extends StatefulWidget {
  final String grpId;
  ...
  @override
  State<UserExamsView> createState() => _UserExamsViewState();
}

class _UserExamsViewState extends State<UserExamsView> {
  bool load = false;
  ...
  Future<void> setData() async {
    ...
    List<UserAssesmentModel> as = await UserController().fetchUserExamData();
    setState(() {
      assesments = as;
      tassesments = as;
    ...
    if (widget.grpId != "all") {
      setState(() {
        assesments = tassesments
            .where((element) => element.grpId == widget.grpId)
            .toList();
      });
    }
  }
